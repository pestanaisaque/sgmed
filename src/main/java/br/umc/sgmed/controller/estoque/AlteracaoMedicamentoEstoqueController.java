 ...
 */
@Controller
public class AlteracaoMedicamentoEstoqueController {
	@Autowired
	...
	@RequestMapping(value = { "/estoque/administracao/buscaAlteracaoMedicamentoEstoque" }, method = RequestMethod.GET)
	public ModelAndView getAlteracaoMedicamentoEstoque() {
	...
	@RequestMapping(value = {
			"/estoque/administracao/resultadoBuscaAlteracaoMedicamentoEstoque" }, method = RequestMethod.GET)
	...
	@RequestMapping(value = "/estoque/administracao/buscaAlteracaoMedicamentoEstoque", method = RequestMethod.POST)
